            ...
            <div class="card-body">
                ...
                <form action="<?= base_url('C_Auth') ?>" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <a href="<?= base_url('C_Home') ?>"><button type="button"
                ...
                <!-- <a href="<?= base_url('C_Auth/register') ?>" class="text-center mt-2">Register a new membership</a> -->

                <p>
                    <a href="<?= base_url('C_Auth/forgotPassword') ?>" class="text-center">Forgot Password</a>
                </p>
